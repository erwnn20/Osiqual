        ...
        <x-page.content icon="house" title="Dashboard">
            ...
            <x-table :data="$tickets['data']" :filter="false" :edit="$tickets['edit']">
                <div class="flex items-end gap-2">
                    <h3 class="text-2xl/tight font-bold">Derniers Tickets</h3>

                    <x-button :href="route('ticket.index')" size="sm" color="link" class="black">
                        <div class="flex items-center">
                            <span class="italic me-1">Voir tous les Tickets</span>
            ...
            <x-table :data="$contracts['data']" :filter="false" :edit="$contracts['edit']">
                <div class="flex items-end gap-2">
                    <h3 class="text-2xl/tight font-bold">Derniers Contrats</h3>

                    <x-button :href="route('contract.index')" size="sm" color="link" class="black">
                        <div class="flex items-center">
                            <span class="italic me-1">Voir tous les Contrats</span>
                            <span class="px-2 py-0.5 rounded-full
                                         text-xs font-semibold tracking-wide uppercase
                                         bg-default-800/15 text-default-800">
                                {{ $contracts['count'] }}
